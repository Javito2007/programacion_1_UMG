...
public:
    ...
    int obtenerSalarioMensual() const {
        return salarioMensual;
    }

    int obtenerSalarioAnual() const {
...
int main() {
    ...
    cout << "Salario anual de " << empleado1.obtenerPrimerNombre() << " "
         << empleado1.obtenerApellidoPaterno() << ": " << empleado1.obtenerSalarioAnual() << endl;
    cout << "Salario anual de " << empleado2.obtenerPrimerNombre() << " "
         << empleado2.obtenerApellidoPaterno() << ": " << empleado2.obtenerSalarioAnual() << endl;

    empleado1.aplicarAumento(10);
    empleado2.aplicarAumento(10);

    cout << "\nDespués del aumento del 10%:" << endl;
    cout << "Salario anual de " << empleado1.obtenerPrimerNombre() << " "
         << empleado1.obtenerApellidoPaterno() << ": " << empleado1.obtenerSalarioAnual() << endl;
    cout << "Salario anual de " << empleado2.obtenerPrimerNombre() << " "
         << empleado2.obtenerApellidoPaterno() << ": " << empleado2.obtenerSalarioAnual() << endl;
